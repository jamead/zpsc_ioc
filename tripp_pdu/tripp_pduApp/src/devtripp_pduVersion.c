...
#include "tripp_pduVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = tripp_pduVERSION;
...
static lsidset devtripp_pduVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devtripp_pduVersion);
